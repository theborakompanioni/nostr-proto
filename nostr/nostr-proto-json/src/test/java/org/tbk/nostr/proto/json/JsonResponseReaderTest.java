...
class JsonResponseReaderTest {
    ...
    void itShouldParseMetadata0() {
        ProfileMetadata metadata = JsonReader.fromJson("""
                {
                  "name": "name",
                  "about": "about",
                  "picture": "https://www.example.com/example.png"
                }
                """, ProfileMetadata.newBuilder());
    ...
    void itShouldParseMetadata2() {
        ProfileMetadata metadata0 = JsonReader.fromJson("{}", ProfileMetadata.newBuilder());
        ...
        ProfileMetadata metadata1 = JsonReader.fromJson("""
                {
                  "name": "name"
                }
                """, ProfileMetadata.newBuilder());
        ...
        ProfileMetadata metadata2 = JsonReader.fromJson("""
                {
                  "about": "about"
                }
                """, ProfileMetadata.newBuilder());
        ...
        ProfileMetadata metadata3 = JsonReader.fromJson("""
                {
                  "picture": "https://www.example.com/example.png"
                }
                """, ProfileMetadata.newBuilder());
